...
class Frame(object):
    ...
    def lookup(self, symbol):
        ...
        elif not self.parent is None: return self.parent.lookup(symbol)
        # END PROBLEM 2
    ...
    def make_child_frame(self, formals, vals):
        ...
        if len(formals) != len(vals):
            raise SchemeError("number of formals does not match with number of vals.")
        child = Frame(self)
...
class BuiltinProcedure(Procedure):
    ...
    def apply(self, args, env):
        ...
        try:
            ...
            raise SchemeError('invalid number of arguments: {0}'.format(len(args)))
        # END PROBLEM 3
...
class LambdaProcedure(Procedure):
    ...
    def make_call_frame(self, args, env):
        ...
        # BEGIN PROBLEM 11
        "*** YOUR CODE HERE ***"
        parent, formals = self.env, self.formals
...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(target):
        ...
        "*** YOUR CODE HERE ***"
        symbol = target.first
        formals, body = target.rest, expressions.rest
